...
import { useSecretConfigStore } from "@/store/useSecretConfigStore";
...
const BasicPanel: React.FC = () => {
  ...
  const { githubToken, setGithubToken } = useSecretConfigStore();
                  ...
                  >
                    ...
                    <div className="mt-4">
                      <div className="flex flex-col gap-2 sm:ml-3 sm:flex-row sm:items-center">
                        <div className="sm:w-[110px]">Access Token</div>
                        <Input
                      ...
                      <div className="mt-4 flex flex-col gap-2 sm:ml-3 sm:flex-row sm:items-center">
                        <div className="sm:w-[110px]">UseName</div>
                        <Input
                          className="flex-1"
