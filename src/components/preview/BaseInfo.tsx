...
import { resumeIcons } from "@/components/editor/resume-icons";
import {
  BasicInfo,
...
const BaseInfo = ({
  ...
  const getIcon = (iconName: string | undefined) => {
    const IconComponent = iconName ? resumeIcons[iconName] : undefined;
  ...
  const photoSize = basic.photoConfig?.width || 100;
